  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "AIRLOCK_DATABASE_POOL_SIZE", value = tostring(var.database_pool_size) },
        { name = "AIRLOCK_DATABASE_MAX_OVERFLOW", value = tostring(var.database_max_overflow) },
        { name = "AIRLOCK_DATABASE_POOL_TIMEOUT_SECONDS", value = tostring(var.database_pool_timeout_seconds) },
